...
function Settings() {
    ...
    <div>
       ...
       <header>
			<nav>
			  ...
			  <svg xmlns="http://www.w3.org/2000/svg" width="25" height="35" fill="currentColor" class="bi bi-patch-question" viewBox="0 0 16 16">
  ...
  <path d="M7.001 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0z"/>
             ...
             <link href="path/to/bootstrap-icons.css" rel="stylesheet"/>
              <a href="/Settings">
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="35" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
			...
			<link href="path/to/bootstrap-icons.css" rel="stylesheet"/>
             <a href="/Login"  >
             <svg xmlns="http://www.w3.org/2000/svg" width="25" height="35" fill="currentColor" class="bi bi-escape" viewBox="0 0 16 16">
